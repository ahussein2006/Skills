...
(
  ID NUMBER NOT NULL
, MODULE_ID NUMBER NOT NULL
, LOG_TYPE VARCHAR2(10 CHAR) NOT NULL 
...
------------------------------------------------------------------------------------------------
CREATE TABLE WF_SIMPLE_MISSIONS 
(
  INSTANCE_ID NUMBER NOT NULL 
, DESTINATION VARCHAR2(100 CHAR)
, INSERTION_DATE DATE NOT NULL 
, LAST_UPDATE_DATE DATE 
, CONSTRAINT PK_WF_SIMPLE_MISSIONS PRIMARY KEY 
  (
    INSTANCE_ID 
  )
  ENABLE 
...
ALTER TABLE WF_SIMPLE_MISSIONS
ADD CONSTRAINT FK_WF_SIMPLE_MISSIONS_WF_INSTANCES_INSTANCE_ID FOREIGN KEY
(
  INSTANCE_ID 
)
REFERENCES WF_INSTANCES
